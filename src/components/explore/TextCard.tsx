...
function TextCard({ text, profile, time, shares, likes, comments }: TextCardType) {
  return (
    <div className="w-full mb-5 flex flex-col justify-start max-w-[800px] bg-slate-200 rounded-md border text-sm border-slate-300 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100">
        ...
        <div className="mx-7 mb-2 border-l-2 border-slate-500 px-2">{text}</div>
