...
export const changeProfile = createAsyncThunk('profile/changeProfile', async ({ token, obj}: { token: string, obj: { name?: string, bio?: string, location?: string } }) => {
  return api
    .patch(`/api/profile`, { bio: obj.bio, name: obj.name, location: obj.location }, {
